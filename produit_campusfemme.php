...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/campusfemme.avif" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">ADIDAS CAMPUS 00S</h2>
        <p class="product-color">Couleur : Black-White</p>
        <p class="product-price">Prix : €115.00</p>
