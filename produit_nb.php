...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/newbalance.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">New Balance 1906R</h2>
        <p class="product-color">Couleur : Beige-Silver</p>
        <p class="product-price">Prix : €109.99</p>
