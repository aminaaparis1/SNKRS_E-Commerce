...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/tn.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Nike Tuned 1</h2>
        <p class="product-color">Couleur : Black</p>
        <p class="product-price">Prix : €189.99</p>
