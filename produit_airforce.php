...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "Nike Air Force 1 Low Bébé";
  $prix = 65.00;
  $taille = $_POST['taille'];
  $color = "White";
  $quantite = 1;
...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/airforce.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Nike Air Force 1 Low Bébé</h2>
