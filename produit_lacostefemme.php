...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/lacostefemme.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Lacoste L003 2K24</h2>
        <p class="product-color">Couleur : Black-Silver</p>
        <p class="product-price">Prix : €159.99</p>
