...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "Nike Shox TL";
  $prix = 169.99;
  $taille = $_POST['taille'];
  $color = "White/ White-Metallic Silver-Max Orange";
  $quantite = 1;
...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/shox.jpeg" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Nike Shox TL</h2>
        <p class="product-color">Couleur : White/ White-Metallic Silver-Max Orange</p>
        <p class="product-price">Prix : €169.99</p>
