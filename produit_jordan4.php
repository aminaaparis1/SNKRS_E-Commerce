...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/jordan4.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Jordan 4 Retro</h2>
        <p class="product-color">Couleur : Black-White-Tour Yellow</p>
        <p class="product-price">Prix : €149.99</p>
