...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "Jordan AJ4 Retro";
  $prix = 64.99;
  $taille = $_POST['taille'];
  $color = "White-Hyper Violet";
  $quantite = 1;
...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/jordanbebe.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Jordan AJ4 Retro</h2>
        <p class="product-color">Couleur : White-Hyper Violet</p>
        <p class="product-price">Prix : €64,99</p>
