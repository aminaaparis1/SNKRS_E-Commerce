...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/ozelia.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Adidas Ozelia</h2>
        <p class="product-color">Couleur : Core Black-Core Black-Core Black</p>
