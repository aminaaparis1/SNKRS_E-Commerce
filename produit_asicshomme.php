...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/asics.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Asics GEL-NYC</h2>
        <p class="product-color">Couleur : Cream-Cream</p>
