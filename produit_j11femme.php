...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "Jordan 11 Retro";
  $prix = 219.99;
  $taille = $_POST['taille'];
  $color = "Lt Iron Ore-Mtlc Sivler-Photon Dust";
  $quantite = 1;
...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/jordan11.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Jordan 11 Retro</h2>
        <p class="product-color">Couleur : Lt Iron Ore-Mtlc Sivler-Photon Dust</p>
        <p class="product-price">Prix : €219,99</p>
