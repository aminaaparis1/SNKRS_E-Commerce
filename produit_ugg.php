...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "UGG Classic Ultra Mini";
  $prix = 175.00;
  $taille = $_POST['taille'];
  $color = "Black";
  $quantite = 1;
...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/ugg.avif" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">UGG Classic Ultra Mini</h2>
        <p class="product-color">Couleur : Black</p>
        <p class="product-price">Prix : €175,00</p>
