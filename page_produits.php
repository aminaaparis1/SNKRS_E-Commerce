   ...
   <nav>
    ...
    <section class="main">  
        <div class="cards">
            ...
            <div class="card">
                <a href="produit_asicshomme.php">
                    <img src="img/asics.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Asics GEL-NYC</h4>
                    <h4 class="price"> € 149,99</h4>
                </div>
                <div class="card-body">
                    <p>Cream-Cream</p>
            ...
            <div class="card">
                <a href="produit_tn.php">
                    <img src="img/tn.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Nike Tuned 1</h4>
                    <h4 class="price">€ 189,99</h4>
                </div>
                <div class="card-body">
                    <p>Black</p>
                </div>
            ...
            <div class="card">
                <a href="produit_nikep6.php">
                    <img src="img/nike.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Nike P-6000</h4>
                    <h4 class="price"> € 119,99</h4>
                </div>
                <div class="card-body">
                    <p>Lt Iron Ore-Mtlc Sivler-Photon Dust</p>
                </div>
            </div>
            <div class="card">
                <a href="produit_lacostefemme.php">
                    <img src="img/lacostefemme.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Lacoste L003 2K24</h4>
            ...
            <div class="card">
                <a href="produit_campusfemme.php">
                    <img src="img/campusfemme.avif">
                </a>
                <div class="card-header">
                    <h4 class="title">ADIDAS CAMPUS 00S</h4>
                    <h4 class="price">€ 115,00</h4>
                </div>
                <div class="card-body">
                    <p>Black-White </p>
                </div>
            ...
            <div class="card">
                <a href="produit_asicsfemme.php">
                    <img src="img/asicsfemme.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Asics GEL-SONOMA</h4>
            ...
            <div class="card">
                <a href="produit_ugg.php">
                    <img src="img/ugg.avif">
                </a>
                <div class="card-header">
                    <h4 class="title">UGG Classic Ultra Mini</h4>
            ...
            <div class="card">
                <a href="produit_j11femme.php">
                    <img src="img/jordan11.webp">
                </a>
                <div class="card-header">
                    <h4 class="title">Jordan 11 Retro</h4>
                    <h4 class="price"> € 219,99</h4>
                </div>
                <div class="card-body">
                    <p>Lt Iron Ore-Mtlc Sivler-Photon Dust</p>
                </div>
