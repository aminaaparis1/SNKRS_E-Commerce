...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/newbebe.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">New Balance 327</h2>
        <p class="product-color">Couleur : Black-Black</p>
        <p class="product-price">Prix : €69,99</p>
