...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/nike.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Nike P-6000</h2>
        <p class="product-color">Couleur : Lt Iron Ore-Mtlc Sivler-Photon Dust</p>
        <p class="product-price">Prix : €119.99</p>
