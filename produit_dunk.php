...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['addToCart'])) {
  ...
  $nomProduit = "Nike Dunk Low";
  $prix = 59.99;
  $taille = $_POST['taille'];
  $color = "Deep Jungle-White-Light Silver";
  $quantite = 1;
...
<body>
    ...
    <input type="search" placeholder="Rechercher" name="s">
      ...
      <?php 
        ...
        if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true){
          // Si l'utilisateur est connecté, affiche un lien vers la page de gestion du compte
          echo '<a href="gestion_compte.php" style="color: #000000;"><i class="fas fa-user"></i><span class="nav-text">Espace personnel</span></a>';
        } else {
          // Sinon, affiche un lien vers la page de connexion
          echo '<a href="page_connexion.php" style="color: #000000;"><i class="fas fa-user"></i><span class="nav-text">Connexion</span></a>';
        }
      ?>
    </div>
  </nav>
  ...
  <div class="product-container">
    <img class="product-image" src="img/dunk.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Nike Dunk Low</h2>
        <p class="product-color">Couleur : Deep Jungle-White-Light Silver</p>
        <p class="product-price">Prix : €59,99</p>
