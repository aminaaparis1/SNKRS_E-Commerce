...
<body>
  ...
  <div class="product-container">
    <img class="product-image" src="img/asicsfemme.webp" alt="Product Image">
    <div class="product-info">
        <h2 class="product-title">Asics GEL-SONOMA</h2>
        <p class="product-color">Couleur : Beige-Silver</p>
        <p class="product-price">Prix : €129,99</p>
